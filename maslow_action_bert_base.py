...
from pybert.train.trainer import Trainer #.trainer_old to .trainer
from torch.utils.data import DataLoader
from pybert.io.maslow_baseline_bert_processor import BertProcessor
from pybert.common.tools import init_logger, logger
from pybert.common.tools import seed_everything
from pybert.configs.maslow_basic_config_action import config
...
def main():
    ...
    parser.add_argument('--data_name', default='maslow_action_base', type=str)
