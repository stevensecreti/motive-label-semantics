...
from pybert.train.reiss_trainer_old import Trainer
from torch.utils.data import DataLoader
from pybert.io.reiss_bert_processor_label2 import BertProcessor
from pybert.common.tools import init_logger, logger
from pybert.common.tools import seed_everything
from pybert.configs.reiss_basic_config_label_finetune_action import config
...
def run_test(args):
    ...
    from pybert.test.reiss_predictor import Predictor
    import pickle
    import os
    processor = BertProcessor(vocab_path=config['bert_vocab_path'], do_lower_case=args.do_lower_case)
...
def main():
    ...
    parser.add_argument('--data_name', default='reiss_action_main_label', type=str)
