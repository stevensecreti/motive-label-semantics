...
checkpoints_name = "maslow_action_checkpoints_leam2"

config = {
    'raw_data_path': BASE_DIR / 'dataset/test_maslow_all_action.csv',
    'test_path': BASE_DIR / 'dataset/train_maslow_all_action.csv',
