...
class Trainer(object):
    ...
    def valid_epoch(self,data):
        ...
        with torch.no_grad():
            ...
            print("Valid Micro-precision: ", micro_precision)
    ...
    def train_epoch(self,data):
        ...
        micro_recall = np.sum(true_positive_by_label) / (np.sum(true_positive_by_label) + np.sum(false_negative_by_label))
        micro_f1 = 2 * micro_precision * micro_recall / (micro_precision + micro_recall)
        print("Train Micro-precision: ", micro_precision)
    ...
    def train(self,train_data,valid_data,seed):
        ...
        for epoch in range(self.start_epoch,self.start_epoch+self.epochs):
            ...
            # save model
            if self.model_checkpoint:
                state = self.save_info(epoch,best=logs['valid_loss'], train_true=train_true)
