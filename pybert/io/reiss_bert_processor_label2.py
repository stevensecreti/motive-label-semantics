    ...
    def create_examples(self,lines,example_type,cached_examples_file):
        ...
        if cached_examples_file.exists():
            ...
            for i,line in enumerate(lines):
                ...
                print (line[0].split("//"))
                text_a = line[0].split("//")[0]   #get the sentence
                text_b = line[0].split("//")[1]   #get the context
                label = line[1]
                char = line[0].split("//")[2]   #get the name of the character
                ...
                char_labels = " ".join([char + " is motivated by " + lab + "."  for lab in reiss]).strip()

                ##append char_labels to text_b separated by [SEP]
                text_b = text_b + char_labels + " [SEP]"
                # text_b = text_b + " [SEP]" + char_labels
                # text_b = text_b + " [SEP]"
