...
from pybert.train.maslow_trainer_label_attn1 import Trainer
from torch.utils.data import DataLoader
from pybert.io.maslow_bert_processor_label_attention2 import BertProcessor
from pybert.common.tools import init_logger, logger
from pybert.common.tools import seed_everything
from pybert.configs.maslow_basic_config_leam2_action import config
...
def run_test(args):
    from pybert.io.maslow_task_data_label import TaskData
    from pybert.test.maslow_predictor_label_attention1 import Predictor
    import os
    import pickle
...
def main():
    ...
    parser.add_argument('--data_name', default='maslow_action_leam_bert', type=str)
